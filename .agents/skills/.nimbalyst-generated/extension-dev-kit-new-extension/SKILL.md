...
Important: treat the text after `/extension-dev-kit-new-extension` as the command arguments. Use those arguments anywhere the original Claude command expects its argument placeholder.
