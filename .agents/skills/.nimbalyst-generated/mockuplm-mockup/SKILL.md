...
Use this when the user explicitly invokes `/mockuplm-mockup` or requests the "mockup" workflow.

Important: treat the text after `/mockuplm-mockup` as the command arguments. Use those arguments anywhere the original Claude command expects its argument placeholder.

Follow this workflow:

Create a visual UX mockup for: the user's command arguments
