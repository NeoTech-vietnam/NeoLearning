---
name: "planning-launch-new-session"
...
Use this when the user explicitly invokes `/planning-launch-new-session` or requests the "launch-new-session" workflow.

Important: treat the text after `/planning-launch-new-session` as the command arguments. Use those arguments anywhere the original Claude command expects its argument placeholder.
