...
void test9(){
    // std::back_inseter contructs a back-insert iterator that inserts new eleemtns
    ...
    // Copy one list to another using an iterator and back_inseter
