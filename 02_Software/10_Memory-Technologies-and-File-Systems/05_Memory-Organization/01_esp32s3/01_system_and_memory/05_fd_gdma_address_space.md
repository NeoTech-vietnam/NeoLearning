...
![alt text](image-4.png)These peripherals/modules can access any memory available to GDMA. For more information, please refer to section GDMA Controller (GDMA)
