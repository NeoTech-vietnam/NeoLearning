...
Use this when the user explicitly invokes `/feedback-bug-report` or requests the "bug-report" workflow.

Important: treat the text after `/feedback-bug-report` as the command arguments. Use those arguments anywhere the original Claude command expects its argument placeholder.
