...
Important: treat the text after `/datamodellm-datamodel` as the command arguments. Use those arguments anywhere the original Claude command expects its argument placeholder.
