...
Use this when the user explicitly invokes `/feedback-feature-request` or requests the "feature-request" workflow.

Important: treat the text after `/feedback-feature-request` as the command arguments. Use those arguments anywhere the original Claude command expects its argument placeholder.
