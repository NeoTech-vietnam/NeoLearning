...
Use this when the user explicitly invokes `/planning-design` or requests the "design" workflow.

Important: treat the text after `/planning-design` as the command arguments. Use those arguments anywhere the original Claude command expects its argument placeholder.
